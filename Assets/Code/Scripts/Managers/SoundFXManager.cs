...
namespace ZombeezGameJam
{
    public class SoundFXManager : MonoBehaviour
    {
        ...
        public void PlaySoundClip(AudioClip a_audioClip, Transform a_parent, float a_volume)
        {
        ...
        public void PlayRandomSoundClip(AudioClip[] a_audioClips, Transform a_parent, float a_volume)
        {
            int randomIndex = Random.Range(0, a_audioClips.Length);
            AudioClip chosenClip = a_audioClips[randomIndex];

            PlaySoundClip(chosenClip, a_parent, a_volume);
        }
